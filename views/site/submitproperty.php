            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <h3 class="title-negative-margin">Listing detalls<span class="special-color">.</span></h3>
                        ...
                        <div class="dark-col margin-top-60">
                            ...
                            <textarea name="message" class="input-full main-input property-textarea" placeholder="Your question"></textarea>
                            <div class="row">
