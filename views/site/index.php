        ...
        <div id="swiper1" class="swiper-container">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="slide-bg swiper-lazy" data-background="<?= Yii::$app->request->baseUrl; ?>/images/slides/1.jpg"></div>
                    <!-- Preloader image -->
                                ...
                                <div class="slide-desc pull-right">
                                    ...
                                    <div class="slide-desc-params">	
                                        ...
                                        <div class="slide-desc-parking">
                                            <img src="<?= Yii::$app->request->baseUrl; ?>/images/parking-icon.png" alt="" />1
                                        </div>	
                                    </div>
                ...
                <div class="swiper-slide">
                    <div class="slide-bg swiper-lazy" data-background="<?= Yii::$app->request->baseUrl; ?>/images/slides/2.jpg"></div>
                    <!-- Preloader image -->
                    <div class="swiper-lazy-preloader swiper-lazy-preloader-white"></div>
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6 slide-desc-col animated slide-desc-2">
                                <div class="slide-desc pull-left">
                                    ...
                                    <div class="slide-desc-params">	
                                        <div class="slide-desc-area">
                                            <img src="<?= Yii::$app->request->baseUrl; ?>/images/area-icon.png" alt="" />350m<sup>2</sup>
                                        </div>
                                        <div class="slide-desc-rooms">
                    ...
                    <div class="video-slide">
                        <video poster="<?= Yii::$app->request->baseUrl; ?>/images/slides/2.jpg" preload="auto" loop autoplay muted>
                            <source src='<?= Yii::$app->request->baseUrl; ?>/images/slides/2.mp4' type='video/mp4' />
                        </video>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="slide-bg swiper-lazy" data-background="<?= Yii::$app->request->baseUrl; ?>/images/slides/3.jpg"></div>
                    <!-- Preloader image -->
                    <div class="swiper-lazy-preloader swiper-lazy-preloader-white"></div>
                    <div class="container">
                        <div class="row">
