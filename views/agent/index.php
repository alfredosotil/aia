...
$this->title = Yii::t('app', 'Agentes');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="row agent-index">
    <div id="title-module" class="page-header wow fadeIn" style=""  data-wow-duration="1000ms">
        <h1><i class='fa fa-fw fa fa-user'></i><span><?= $this->title; ?></span></h1>    
    </div>
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Crear nuevo Agente','class'=>'btn btn-default']).
