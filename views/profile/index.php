...
<div class="profile-index">
    <div id="title-module" class="page-header wow fadeIn" style=""  data-wow-duration="1000ms">
        <h1><i class='fa fa-fw fa-tags'></i><span><?= $this->title; ?></span></h1>    
    </div>
    <div id="ajaxCrudDatatable">
        ...
        GridView::widget([
            ...
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['role' => 'modal-remote', 'title' => 'Create new Profiles', 'class' => 'btn btn-default']) .
