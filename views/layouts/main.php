...
<html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCmMpdRHIBFlnUCmXElc1yjHYxPdEAsJCc&amp;sensor=false&amp;libraries=places"></script>
        <?php $this->head() ?>
