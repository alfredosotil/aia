...
<div class="type-index">
    ...
    <div id="ajaxCrudDatatable">
        ...
        GridView::widget([
            ...
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['role' => 'modal-remote', 'title' => 'Create new Types', 'class' => 'btn btn-default']) .
            ...
            'panel' => [
                'type' => 'info',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Types listing',
