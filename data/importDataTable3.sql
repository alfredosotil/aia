...
INSERT INTO `state` (`id`, `state`, `category`, `active`) VALUES (1,'active','user',1),(2,'Alquiler','property',1),(3,'Venta','property',1);
...
INSERT INTO `type` (`id`, `type`, `category`, `active`) VALUES (1,'admin','user',1),(2,'AIA admin App','module',1),(3,'AIA admin Agentes','module',1),(4,'AIA admin Propiedades','module',1),(5,'Casa','property',1),(6,'Departamento','property',1),(7,'Local','property',1),(8,'Terreno','property',1),(9,'Agente','user',1);
...
-- Dump completed on 2016-06-14 16:55:07
