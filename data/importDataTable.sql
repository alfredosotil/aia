...
INSERT INTO `accesspropertydetail` (`id`, `property_id`, `property_detail_id`, `active`) VALUES (19,1,1,1),(20,1,2,1),(21,1,3,1),(22,1,4,1),(23,1,5,1),(24,1,6,1);
...
INSERT INTO `departamento` (`idDepa`, `departamento`) VALUES (1,'AMAZONAS'),(2,'ANCASH'),(3,'APURIMAC'),(4,'AREQUIPA'),(5,'AYACUCHO'),(6,'CAJAMARCA'),(7,'CALLAO'),(8,'CUSCO'),(9,'HUANCAVELICA'),(10,'HUANUCO'),(11,'ICA'),(12,'JUNIN'),(13,'LA LIBERTAD'),(14,'LAMBAYEQUE'),(15,'LIMA'),(16,'LORETO'),(17,'MADRE DE DIOS'),(18,'MOQUEGUA'),(19,'PASCO'),(20,'PIURA'),(21,'PUNO'),(22,'SAN MARTIN'),(23,'TACNA'),(24,'TUMBES'),(25,'UCAYALI');
...
INSERT INTO `images_property` (`id`, `property_id`, `name`, `order`, `active`) VALUES (4,1,'bU9IBjJ8mH8wNSofeLuKwGZ_yIotsEsi.jpg',1,1);
...
INSERT INTO `property` (`id`, `type_id`, `state_id`, `price`, `money`, `commission`, `area`, `bedrooms`, `bathrooms`, `longitude`, `latitude`, `active`, `datecreation`, `datestart`, `datelastupdate`, `owner`, `phoneowner`, `emailowner`, `address`, `references`, `priority`, `garages`, `yearsold`, `furnished`, `description`, `user_id`, `distrito_id`) VALUES (1,5,2,130000,'S',2,34,4,3,'-77.10658505558968','-12.071384797760047',1,'2016-07-19 21:24:57','2016-07-23 05:00:00','2016-07-19 21:52:24','alfredo sotil ','997893527','alfredosotil@gmail.com','Paradero Astete, La Perla 07016, Perú','calle san miguel',5,1,5,1,'casa grande, amoblada y cerca a la ciudad.',1,1286);
...
-- Dump completed on 2016-07-19 17:29:23
