...
INSERT INTO `access` (`id`, `profile_id`, `module_id`) VALUES (3,1,3),(4,1,1),(5,1,4),(8,2,2),(9,1,2),(10,1,5),(11,1,7),(12,1,6);
...
INSERT INTO `type` (`id`, `type`, `category`, `active`) VALUES (1,'admin','user',1),(2,'AIA admin App','module',1),(3,'AIA admin Agentes','module',1),(4,'AIA admin Propiedades','module',1);
...
INSERT INTO `user` (`id`, `names`, `surnames`, `email`, `username`, `password`, `active`, `lastupdate`, `type_id`, `state_id`, `sex`, `profile_id`, `authKey`, `accessToken`) VALUES (1,'Alfredo Antonio','Sotil Pastor','alfredosotil@gmail.com','asotilp','asotilp',1,'2015-08-10 21:29:24',1,1,'M',1,NULL,NULL),(2,'test','test','test','test','test',1,'2016-06-09 17:37:58',1,1,'M',2,'','');
...
-- Dump completed on 2016-06-13 16:15:21
